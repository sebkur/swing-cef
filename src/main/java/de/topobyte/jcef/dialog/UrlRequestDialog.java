...
public class UrlRequestDialog extends JDialog
{
	...
	public UrlRequestDialog(Frame owner, String title)
	{
		...
		JPanel requestModePanel = createPanelWithTitle("HTTP Request Mode", 1,
				0);
		...
		addRequestFlag(flagsPanel, "Skip cache",
		...
		JPanel headerValues = createPanelWithTable("Header Values",
				headerTblModel);
	...
	private void addRequestMode(JPanel panel, ButtonGroup buttonGrp,
			String requestMode, boolean selected)
	{
	...
	private void addRequestFlag(JPanel panel, String flag, int value,

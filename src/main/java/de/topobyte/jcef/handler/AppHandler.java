...
public class AppHandler extends CefAppHandlerAdapter
{
	...
	{
		if (registrar.addCustomScheme(SearchSchemeHandler.scheme, true, false,
				false, false, true, false, false)) {
			System.out.println(
					"Added scheme " + SearchSchemeHandler.scheme + "://");
		}
		if (registrar.addCustomScheme(ClientSchemeHandler.scheme, true, false,
				false, false, true, false, false)) {
			System.out.println(
					"Added scheme " + ClientSchemeHandler.scheme + "://");
		}
	}
	...
	public void onContextInitialized()
	{
		...
		cefApp.registerSchemeHandlerFactory(SearchSchemeHandler.scheme,
				SearchSchemeHandler.domain, new SchemeHandlerFactory());
		cefApp.registerSchemeHandlerFactory(ClientSchemeHandler.scheme,
				ClientSchemeHandler.domain, new SchemeHandlerFactory());
	}

	// (3) The SchemeHandlerFactory creates a new ResourceHandler instance for
	// each

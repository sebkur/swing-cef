...
import de.topobyte.jcef.dialog.CertErrorDialog;
import de.topobyte.jcef.dialog.PasswordDialog;
		...
		implements CefRequestHandler
{
	...
	{
		// the non existing domain "foo.bar" is handled by the ResourceHandler
		// implementation
		// E.g. if you try to load the URL http://www.foo.bar, you'll be
		// forwarded
